...
public class GlobalDeclList extends GlobalDeclarationList {

    private GlobalDeclarationList GlobalDeclarationList;
    private GlobalDeclaration GlobalDeclaration;

    public GlobalDeclList (GlobalDeclarationList GlobalDeclarationList, GlobalDeclaration GlobalDeclaration) {
